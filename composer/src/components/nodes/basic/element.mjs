...
function create_else_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(g, file, 121, 2, 2614);
		},
...
function create_each_block(ctx) {
	...
	const block = {
		c: function create() {
			g = svg_element("g");
			rect = svg_element("rect");
			attr_dev(rect, "class", rect_class_value = "wireHandle " + (/*port*/ ctx[8].type ? "out" : "in") + " svelte-r6ii83");
			attr_dev(rect, "rx", "3");
			attr_dev(rect, "ry", "3");
			set_style(rect, "width", /*styles*/ ctx[2].wireHandle.width + "px");
			set_style(rect, "height", /*styles*/ ctx[2].wireHandle.height + "px");
			add_location(rect, file, 104, 8, 2246);
			...
			add_location(g, file, 100, 6, 2071);
		},
		m: function mount(target, anchor) {
			insert_dev(target, g, anchor);
			append_dev(g, rect);
		...
		p: function update(ctx, dirty) {
			if (dirty & /*node*/ 1 && rect_class_value !== (rect_class_value = "wireHandle " + (/*port*/ ctx[8].type ? "out" : "in") + " svelte-r6ii83")) {

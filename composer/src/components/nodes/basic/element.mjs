...
/* src/components/nodes/basic/src/Element.svelte generated by Svelte v3.22.2 */

const { Object: Object_1 } = globals;
const file = "src/components/nodes/basic/src/Element.svelte";

function add_css() {
	var style = element("style");
	style.id = "svelte-1nsm6yg-style";
	style.textContent = ".node.svelte-1nsm6yg{fill:rgb(231, 231, 174, 0.75);stroke:#999;stroke-width:1px;cursor:move}.node.selected.svelte-1nsm6yg{stroke:orange;stroke-width:2px}.wireHandle.svelte-1nsm6yg{stroke:#999;stroke-width:1;fill:#d9d9d9;cursor:crosshair}text.svelte-1nsm6yg{fill:black;cursor:move;user-select:none}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
...
function create_else_block(ctx) {
	...
	const block = {
		c: function create() {
			g = svg_element("g");
			attr_dev(g, "id", g_id_value = "" + (/*node*/ ctx[0].id + ":0"));
			add_location(g, file, 122, 2, 2637);
		},
		m: function mount(target, anchor) {
			insert_dev(target, g, anchor);
		},
		p: function update(ctx, dirty) {
			if (dirty & /*node*/ 1 && g_id_value !== (g_id_value = "" + (/*node*/ ctx[0].id + ":0"))) {
...
// (93:0) {#if node.id !== 'wireHandleNode'}
function create_if_block(ctx) {
	let rect;
	let t0;
	let t1;
	let text_1;
	let t2_value = !!/*selected*/ ctx[1] + "";
	let t2;
	...
	const block = {
		c: function create() {
			...
			t2 = text(t2_value);
			attr_dev(rect, "class", "node dragHandle svelte-1nsm6yg");
			attr_dev(rect, "rx", "10");
			attr_dev(rect, "ry", "10");
			...
			add_location(rect, file, 93, 2, 1884);
			attr_dev(text_1, "class", "dragHandle svelte-1nsm6yg");
			attr_dev(text_1, "x", "50%");
			attr_dev(text_1, "y", "50%");
			attr_dev(text_1, "text-anchor", "middle");
			attr_dev(text_1, "dominant-baseline", "middle");
			add_location(text_1, file, 113, 2, 2490);
		},
		m: function mount(target, anchor) {
		...
		p: function update(ctx, dirty) {
			...
			if (dirty & /*selected*/ 2 && t2_value !== (t2_value = !!/*selected*/ ctx[1] + "")) set_data_dev(t2, t2_value);
		},
		d: function destroy(detaching) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(93:0) {#if node.id !== 'wireHandleNode'}",
		ctx
	});
...
// (101:4) {#each node.ports as port, i}
function create_each_block(ctx) {
	...
	const block = {
		c: function create() {
			g = svg_element("g");
			rect = svg_element("rect");
			attr_dev(rect, "class", rect_class_value = "wireHandle " + (/*port*/ ctx[8].type ? "out" : "in") + " svelte-1nsm6yg");
			attr_dev(rect, "rx", "3");
			attr_dev(rect, "ry", "3");
			set_style(rect, "width", /*styles*/ ctx[2].wireHandle.width + "px");
			set_style(rect, "height", /*styles*/ ctx[2].wireHandle.height + "px");
			add_location(rect, file, 105, 8, 2269);
			...
			add_location(g, file, 101, 6, 2094);
		},
		m: function mount(target, anchor) {
			insert_dev(target, g, anchor);
			append_dev(g, rect);
		...
		p: function update(ctx, dirty) {
			if (dirty & /*node*/ 1 && rect_class_value !== (rect_class_value = "wireHandle " + (/*port*/ ctx[8].type ? "out" : "in") + " svelte-1nsm6yg")) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(101:4) {#each node.ports as port, i}",
		ctx
	});
...
function create_fragment(ctx) {
	...
	function select_block_type(ctx, dirty) {
		if (/*node*/ ctx[0].id !== "wireHandleNode") return create_if_block;
...
class Element extends SvelteComponentDev {
	constructor(options) {
		super(options);
		if (!document.getElementById("svelte-1nsm6yg-style")) add_css();
